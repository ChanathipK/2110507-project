...
export default function Footer() {
    return (
        <footer className="w-full h-[400px] max-h-[400px] sm:h-[300px] sm:max-h-[400px] md:h-36 relative bottom-0 left-0 bg-slate-600 flex justify-center items-center text-slate-50 overflow-hidden">
